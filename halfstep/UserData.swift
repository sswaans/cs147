...
class UserData {
    ...
    private init() {
        ...
        users = []
        let userDictionaryArray = [["allUserEvents": ["practiced today", "practiced yesterday", "leveled up in 'play all major scales'", "set a new goal: 'play all minor scales'", "became friends with beyonce", "became friends with jayz"],
                                    "currentGoal": 0,
                                    "currentLesson": 0,
                                   ...
                                   ["allUserEvents": ["practiced today", "practiced yesterday", "leveled up in 'play all major scales'", "set a new goal: 'play all minor scales'", "became friends with ringo starr", "became friends with jayz"],
                                    "currentGoal": 2,
                                    "currentLesson": 12,
                                    "friends": ["jayz",
                                                "david",
                                    ...
                                    "name": "beyonce",
                                    "imagePath": "beyonce"],
                                   ["allUserEvents": ["practiced today", "practiced yesterday", "leveled up in 'play all major scales'", "set a new goal: 'play all minor scales'", "became friends with beyonce", "became friends with john lennon"],
                                    "currentGoal": 2,
                                    "currentLesson": 13,
                                    "friends": ["beyonce",
                                                "david",
